      ...
      <div className="container projects_container">
        <article className="project_item">
          ...
          <div className="project_description">
            <p>
              Hotel booking website made with React and Sass. This was my first
              big react project, it has a few missing features since the main
              goal was to meet the criteria for the brief. I used strapi to make
              my API data and deployed in on Heroku.
            </p>
          </div>
        ...
        <article className="project_item">
          ...
          <div className="project_description">
            <p>
              ...
              This was a school project and has some features missing that were
              not part of the tasks. Strapi was used as an API to get
        ...
        <article className="project_item">
          ...
          <div className="project_description">
            <p>
              Made using NEXT js. I
              used a free api from fakestoreapi.com for a list of products and a
              Strapi deployed on Heroku for the use of login and JWT token.
              There is also a contact form with my first attempt of using the
